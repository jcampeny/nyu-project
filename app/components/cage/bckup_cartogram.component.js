...
//         d3.json('/localdata/vizdata/countries_110.json', function(topo) {
//         // d3.json('/localdata/vizdata/bern.topojson', function(topo) {
//           topology = topo;

//           // The mapped unit for communes: Communes
//           geometries = topology.objects.ne_110m_admin_0_countries.geometries;
//           // geometries = topology.objects.bern.geometries;

//           // Read the data for the cartogram
//           d3.csv("/localdata/vizdata/usa_exports.csv", function(data) {

//             // Prepare a function to easily access the data by its ID
//             // "ID" for communes: Name
//             dataById = d3.nest()
...
//           for(var i=cartoFeatures.length-1 ; i>0 ; i--){
//             if(cartoFeatures[i].id === "-99"){
//                 cartoFeatures.splice(i,1);
//             }
//           }
...
//           mapFeatures.attr("transform", "translate(" + d3.event.translate + ")scale(" + d3.event.scale + ")").style("stroke-width", 0.5 / d3.event.scale + "px");
